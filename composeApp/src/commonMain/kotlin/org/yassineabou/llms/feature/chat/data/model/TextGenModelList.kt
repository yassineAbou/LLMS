...
object TextGenModelList {
    ...
    val ultraEfficientModels = listOf(
        TextModel(
            ...
            modelName = "nova-fast",
            description = "~66.7K/pollen"
        ),
        TextModel(
            title = "Gemini 2.5 Flash Lite",
            modelName = "gemini-fast",
            description = "~3.6K/pollen"
        ),
        TextModel(
            title = "Mistral Small 3.2",
            modelName = "mistral",
            description = "~3.2K/pollen"
        )
    )
    ...
    val highEfficiencyModels = listOf(
        TextModel(
            ...
            description = "~1.4K/pollen"
        ),
        TextModel(
            title = "xAI Grok 4 Fast",
            modelName = "grok",
            description = "~950/pollen"
        ),
        TextModel(
            title = "GPT-5 Mini",
            modelName = "openai",
            description = "~800/pollen"
        ),
        TextModel(
            title = "Perplexity Sonar",
            modelName = "perplexity-fast",
            description = "~750/pollen"
        ),
        TextModel(
            title = "GPT-5 Nano",
            modelName = "openai-fast",
            description = "~650/pollen"
        )
    )
    ...
    val balancedModels = listOf(
        TextModel(
            ...
            modelName = "gemini",
            description = "~400/pollen"
        ),
        TextModel(
            title = "DeepSeek V3.2",
            modelName = "deepseek",
            description = "~300/pollen"
        ),
        TextModel(
            title = "Gemini 2.5 Pro",
            modelName = "gemini-legacy",
            description = "~150/pollen"
        ),
        TextModel(
    ...
    val premiumModels = listOf(
        TextModel(
            ...
            description = "~90/pollen"
        ),
        TextModel(
            title = "Claude Haiku 4.5",
            modelName = "claude-fast",
            description = "~50/pollen"
        ),
        TextModel(
            title = "MiniMax M2.1",
            modelName = "minimax",
            description = "~45/pollen"
        ),
        TextModel(
            title = "Claude Sonnet 4.5",
            modelName = "claude",
            description = "~25/pollen"
        ),
        TextModel(
            title = "Gemini 3 Pro",
