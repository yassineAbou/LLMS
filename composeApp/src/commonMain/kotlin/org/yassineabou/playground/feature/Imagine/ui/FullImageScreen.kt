...
fun FullScreenImage(
    ...
    var isLargeScreen by remember { mutableStateOf(windowSizeClass.widthSizeClass > WindowWidthSizeClass.Medium) }

    LaunchedEffect(windowInfo) {
        isLargeScreen = windowInfo.containerSize.width > 840
        if (isLargeScreen) {
